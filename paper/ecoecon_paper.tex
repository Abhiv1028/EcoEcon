...
24 months or longer. CSD signals alone achieve LOO AUC = 1.000, confirming that
network metrics are not required for classification performance at this sample size;
the network-only specification achieves AUC = 0.400, consistent with EBI being the
weakest individual signal.
